    ...
    <section id="delivery" className="py-20">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-10 rounded-2xl bg-gray-50 p-6 text-center text-sm text-gray-500 dark:bg-zinc-800 dark:text-gray-400">
          После оплаты доступ активируется автоматически. VPN-ключи доступны
          в личном кабинете. Если у вас возникли вопросы — напишите в{" "}
          <a
            href="#delivery"
...
const steps = [
  ...
  },
  {
    ...
    text: "После подтверждения оплаты доступ активируется автоматически. VPN-ключи доступны в личном кабинете.",
  },
  {
    title: "Подключение",
    text: "Используйте VPN-ключи в приложениях Karing, v2rayTune, Happ, v2rayNG и других.",
  },
];
