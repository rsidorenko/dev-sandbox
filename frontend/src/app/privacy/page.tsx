        ...
        <div className="space-y-6">
          ...
          <Section title="2. Какие данные мы собираем">
            ...
            <ul className="list-disc space-y-1 pl-5">
              ...
              <Li>Данные платежа, обрабатываемые платёжным сервисом, подключённым Исполнителем</Li>
            </ul>
          ...
          <Section title="4. Защита данных">
            ...
            <P>
              Платёжные данные обрабатываются подключённым платёжным сервисом и не хранятся на серверах Оператора.
            </P>
          </Section>
          ...
          <Section title="5. Передача данных третьим лицам">
            ...
            <ul className="list-disc space-y-1 pl-5">
              <Li>Платёжному сервису, подключённому Исполнителем — для обработки платежей</Li>
