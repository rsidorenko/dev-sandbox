...
async def run():
    ...
    try:
        ...
        if os.environ.get("SET_LTE_SNI", "true") == "true":
            sni_map = {
                10: ("eh.vk.com", "d5ba"),          # Франкфурт LTE (Yandex 84.201.144.227)
                14: ("music.yandex.ru", "d5ba"),    # Франкфурт 2 LTE (80.78.254.171)
                12: ("rutube.ru", "3b7b444fb3"),    # Лос-Анджелес LTE (194.67.120.48)
                13: ("max.ru", "4aabe94ad1279c7f"), # Хельсинки LTE (95.163.223.132)
            }
